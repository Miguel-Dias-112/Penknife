package com.example.farmcontrol.Telas.TelaLembretes.ListasAdpters.EssaSemana
...
class LembretesSemanaAdapter(var context: Context) : RecyclerView.Adapter<LembretesSemanaAdapter.ViewHolder>() {
