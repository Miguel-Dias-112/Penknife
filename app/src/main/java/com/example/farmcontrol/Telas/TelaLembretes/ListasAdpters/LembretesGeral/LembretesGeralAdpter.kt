package com.example.farmcontrol.Telas.TelaLembretes.ListasAdpters.LembretesGeral
...
class LembretesGeralAdpter(var context: Context) :
    RecyclerView.Adapter<LembretesGeralAdpter.ViewHolder>() {
