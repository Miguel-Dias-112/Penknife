package com.example.farmcontrol.Telas.ChatFrag.ChatGpt
...
import com.example.farmcontrol.Telas.ChatFrag.ChatGptManager.ChatGptApi
import com.example.farmcontrol.Telas.ChatFrag.ClassesModelos.Message
...
class ChatView(var view:View, var context: Context) {
    ...
    init {
       ...
       //    perguntarChatGPT(context, chatlist,"Você é o penk um pastor suiço magico que ajuda com questões de prudutividade")
