...
import com.example.PenKnife.dialogs.ScreenManager.Companion.calendar
import com.example.PenKnife.dialogs.ScreenManager.Companion.datapicker
import com.example.PenKnife.dialogs.ScreenManager.Companion.firstFragment_fragmentmanager
import com.example.PenKnife.dialogs.ScreenManager.Companion.timepicker
    ...
    init {
            ...
            botão_criar.setOnClickListener(){
                ...
                if (!nome.isBlank()){
                        ...
                        var lembrete =  Lembrete(nome, intervalo, dias_tomando, calendar,context)
